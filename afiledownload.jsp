...
String image=null;
	...
	String sql="select *  from agentfile where id='"+id+"' ";
	try
	{
...
<div id="wrapper"> 
    ...
    <div class="inner"> 
      <ul>
        ...
        <li><a href="pagentdistributorfiles.jsp"><span class="link">Distributor 
          Files</span></a></li>
        <li><a href="pagentfile.jsp" class="current"><span class="link">Agent 
          Files</span></a></li>
  ...
  <div id="hold"> 
    <div id="content"> 
      <div id="subheader"> 
        <h2>VIEW FILES SENT BY AGENT</h2>
      </div>
      <div id="leftcolumn"> 
...
-webkit-border-radius: 10px ; width:300px;  margin: 0px  100px;">
        <table align="center">
          ...
          <%while(rs.next()){%>
          <tr> 
            <td width="50px"> <font color="#000000" size="2">File</font></td>
            <td width="150px"> <font color="#660000" size="2"> 
              <%=rs.getString("filename")%>
              </font> </td>
          </tr>
          <tr> 
            <td width="150px"> <font color="#000000" size="2">Subject</font></td>
            <td width="150px"> <font color="#660000" size="2"> 
              <%=rs.getString("subject")%>
              </font> </td>
          </tr>
          <tr> 
            <td width="150px"> <font color="#000000" size="2">Date</font></td>
            <td width="150px"> <font color="#660000" size="2"> 
              <%=rs.getString("date")%>
              </font> </td>
          </tr>
