...
String image=null;
	...
	String sql="select * from agentfile where username='"+agentname+"' ";
...
-webkit-border-radius: 10px ; width:500px;  margin: 0px  0px;">
        <table>
          <tr> 
          ...
          <tr> 
            ...
            <td> <a href="afiledownload.jsp?id=<%=rs.getString("id")%>">Details</a> 
            </td>
          </tr>
          <%}%>
        </table>
