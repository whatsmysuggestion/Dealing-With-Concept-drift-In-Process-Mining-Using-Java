...
ArrayList list = new ArrayList();
	...
	while (files.hasMoreElements()) 
	{
		...
		if(paramname != null)
		{
			...
			session.setAttribute("newagent",user);
			...
			String sql2="select name from profile where name!='"+agentname+"'";
			String sql1="select datafile from file where filename='"+fname+"'";			
			String sql="select id from profile where name='"+user+"'";
      ...
      /* if(f == 0)
		...
		else if(f == 1)
		{
			...
			if(x!=0)
			{
				response.sendRedirect("agentfileinsert1.jsp?message=success");
			}
			else
			{
