		...
		if(rs1.next()){
			...
			compose1=rs1.getInt("compose");
				...
				if(rs1.next()){
					...
					if((compose2)==(compose1) | (compose2)>(compose1)){
						response.sendRedirect("agentsend.jsp");
					}
					else{
						//mail part
						//String agentname=(String)session.getAttribute("agentname");
						...
						String messageText ="<b>"+agentname+"</b> trying to send "+filename+" file to "+newagent+"</b>";
						...
						try {
							...
							response.sendRedirect("sendleaker1.jsp");
						}
						catch (Exception err) {
