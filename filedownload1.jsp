...
<body>
	<form name="ff" method="post" action="userfileview.jsp">
  <div id="wrapper"> 
    <div id="header"> 
...
-webkit-border-radius: 10px ; width:300px;  margin: 0px  100px;">
          <table align="center">
            <tr> 
              <td colspan="2" align="center"><blink><font color="#FF0000" size="+2">Enter 
                Secret Key</font></blink></td>
            </tr>
            <tr> 
              <td width="150px"><font color="#000000">Secret Key</font></td>
              <td width="150px"> <input type="text" name="skey" style="border: 2px solid #CC6600" > 
              </td>
            </tr>
            <tr> 
              <td colspan="2" align="center"> <input type="submit" name="sub" value="Download" style="border: 2px solid #CC6600" > 
              </td>
            </tr>
          </table>
          </fieldset>
